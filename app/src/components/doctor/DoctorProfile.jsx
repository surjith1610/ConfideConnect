...
const DoctorProfileUpdate = ({ user, showProfileUpdate }) => {
  ...
  useEffect(() => {
      const fetchDoctor = async () => {
          try {
              const response = await doctorService.getDoctor(user.user._id);
  ...
  const handleSubmit = (values, { setSubmitting }) => {
      ...
      doctorService.updateDoctor(user.user._id,values)
        .then(() => handleClose())
        .catch(err => {
  ...
  <Box>
      ...
      >
       ...
       >
        ...
        <Formik
         key={doctor.doctorId || 'new-doctor'}
          initialValues={
              {
                  ...doctor,
          }}
